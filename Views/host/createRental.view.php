...
<!-- Main Form Card -->
 <form action="/Controllers/RentalController.php" method="POST" enctype="multipart/form-data" >
...
<input class="form-input flex w-full rounded-lg border border-[#e2dfdf] dark:border-[#444] bg-white dark:bg-[#1c1716] h-12 px-4 text-base placeholder:text-[#9ca3af] focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="e.g. Cozy Cottage in the Woods" name="title" value="Modern Loft in Downtown"/>
</label>
...
<input class="form-input flex w-full rounded-lg border border-[#e2dfdf] dark:border-[#444] bg-white dark:bg-[#1c1716] h-12 pl-10 pr-4 text-base placeholder:text-[#9ca3af] focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="e.g. Portland, OR" name="city" value="Seattle, WA"/>
</div>
</label>
<!-- Price -->
<label class="flex flex-col gap-2">
...
<input class="form-input flex w-full rounded-lg border border-[#e2dfdf] dark:border-[#444] bg-white dark:bg-[#1c1716] h-12 pl-8 pr-4 text-base placeholder:text-[#9ca3af] focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="0.00" name="price" type="number" value="185"/>
</div>
</label>
</div>
<!-- Description -->
...
<textarea class="form-textarea flex w-full rounded-lg border border-[#e2dfdf] dark:border-[#444] bg-white dark:bg-[#1c1716] min-h-[140px] p-4 text-base placeholder:text-[#9ca3af] focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-y" name="description" placeholder="Tell guests what makes your place special..."></textarea>
</label>
</div>
...
<div class="flex items-center justify-between p-4 rounded-lg border border-[#e2dfdf] dark:border-[#444] bg-white dark:bg-[#1c1716]">
  ...
  <input 
    ...
    value="4" 
    min="1" 
    class="w-16 text-center border border-[#e2dfdf] dark:border-[#444] rounded-lg px-2 py-1
           bg-white dark:bg-[#1c1716] text-[#161313] dark:text-white"
  >
</div>
...
<div
  class="flex items-center justify-between p-4 rounded-lg
         ...
         bg-white dark:bg-[#1c1716]">

  <div class="flex flex-col">
    <span class="text-base font-medium text-[#161313] dark:text-white">
      Photo
    </span>
    <span class="text-xs text-[#7c706e]">
      Cover image
    </span>
  </div>
  ...
  <div class="flex items-center gap-3">
    ...
    <img
      id="photoPreview"
      class="hidden w-12 h-12 rounded-lg object-cover border"
    />
  ...
  <div class="border border-[#e2dfdf] dark:border-[#444] rounded-xl p-4 md:p-6 bg-white dark:bg-[#1c1716]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="flex flex-col gap-2">
        <label class="text-sm font-medium text-[#161313] dark:text-white">
          Available from
        </label>
        <input
          type="date"
          name="available_from"
          class="border border-[#e2dfdf] dark:border-[#444] rounded-lg px-3 py-2
                 bg-white dark:bg-[#1c1716] text-[#161313] dark:text-white"
          required
        >
      </div>
    ...
    <p class="text-xs text-[#7c706e] mt-4">
      Guests will be able to book between these dates
    </p>
...
<button class="px-8 py-3 text-base font-bold text-white bg-primary hover:bg-[#a6746d] rounded-lg shadow-sm hover:shadow-md transition-all flex items-center gap-2" name="createRental">
